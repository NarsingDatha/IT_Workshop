...
documentation, please visit our \textcolor{blue}{help library}, or head to our plans page to \textcolor{blue}{choose your plan}.
	...
	\begin{figure}[htbp]
		\centering
		\includegraphics[width=0.5\textwidth]{/home/princedattu/Pictures/frog.jpg}
...
\begin{table}[h]
	...
	Use the table and tabular environments for basic
	 tables — see Table 1, for example. For more infor-
...
\vspace{2cm}
\fontsize{25}{10}{\textbf{References}}
\\
